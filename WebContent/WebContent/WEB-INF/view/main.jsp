...
<style>
    ...
    .message-card.sent .message-header strong { color: var(--secondary); }
    ...
    .message-body {
        ...
        background-size: 100% 2.14em; /* 1.2em * 1.8 - adjusted */
...
<div class="sidebar">
    <h2>メニュー</h2>
    <ul>
        <li><a href="LetterMain" class="active">受信箱</a></li>
        ...
        <div class="card">
            ...
            <% } else { %>
                <% for (LetterDto letter : letterList) { %>
                    <% boolean isSent = letter.getSenderId() == loginUser.getUserId(); %>
                    <div class="message-card <%= isSent ? "sent" : "" %>">
                        <div class="letter-wrapper">
                            <div class="message-header">
                                <% if (isSent) { %>
                                    <strong>To: <%= escape(letter.getRecipientName()) %></strong>
                                <% } else { %>
                                    <strong>From: <%= escape(letter.getSenderName()) %></strong>
                                <% } %>
                            </div>
